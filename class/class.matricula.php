...
class matricula{
	...
	public function save_matricula(){
		...
		if($carro == $this->id && $anio_matriculado == $this->anio2){
    	echo $this->_message_error("No puede matricular dos veces el mismo vehiculo en un mismo año.");
		}else {
	...
	public function get_form($id){
		...
		<input type="hidden" name="op" value="' . $op  . '">
			<table border="0" align="center">
				...
				<tr>
					<td>Anio:</td>
					<td>' . $this->_get_combo_anio("anio2",2010) . '</td>
				</tr>
				<tr>
